...
function Home() {
  ...
  return (
    <div className="w-screen h-screen overflow-hidden text-white bg-black md:grid md:grid-cols-2">
      <div
        onClick={handleTextChange}
        className="flex flex-col justify-center gap-4 mx-auto w-[80%] md:ml-[30%] h-full "
      >
        {showClick && (
          <div className="opacity-40 animate-bounce">click &darr;</div>
        )}
      ...
      <div className="relative items-center justify-center hidden h-screen md:flex">
        <div className="absolute z-0 flex justify-center w-[90%] h-full transform skew-y-12 bg-white rounded-full animate-slide-in -bottom-1/4">
          <img
            src="me.png"
            alt="Choi Ho"
            className="z-10 animate-float-up-down"
          />
        </div>
      </div>
    </div>
